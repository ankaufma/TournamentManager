...
class TeamSpec extends Specification {
  ...
  "A new Team" should {
    "have been created with name 'FCB'" in {
      team.name must be_==("FCB")
    }
  }

  "A new Team" should {
    "have been created with name index '0'" in {
      team.index must be_==(0)
    }
  }

  "A new Team" should {
    "have been created with name points '0'" in {
      team.points must be_==(0)
    }
  }

  "A new Team" should {
    "have been created with name goals '0'" in {
      team.goals must be_==(0)
    }
  }

  "A new Team" should {
    "have been created with name goals Against '0'" in {
